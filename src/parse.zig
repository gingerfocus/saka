...
pub export var rules: [*c][*c]struct_rule = undefined;
pub export var nrules: usize = undefined;

pub export var parse_errors: c_int = 0;

pub extern var formerpath: [*c]const u8;
pub const struct_passwd = opaque {};
pub extern fn prepenv([*c]const struct_rule, ?*const struct_passwd, ?*const struct_passwd) [*c][*c]u8;
...
const union_unnamed_7 = extern union {
    ...
    strlist: [*c][*c]const u8,
    str: [*c]const u8,
};
pub const yystype = extern struct {
    unnamed_0: union_unnamed_7,
    lineno: c_int,
    colno: c_int,
};
pub export var yyfp: [*c]FILE = @import("std").mem.zeroes([*c]FILE);
pub var maxrules: usize = @import("std").mem.zeroes(usize);
pub fn arraylen(arg_arr: [*c][*c]const u8) callconv(.C) usize {
    var arr = arg_arr;
    var cnt: usize = 0;
    while (arr.* != null) {
        cnt +%= 1;
...
pub const TPERMIT: c_int = 258;
pub const TDENY: c_int = 259;
pub const TAS: c_int = 260;
pub const TCMD: c_int = 261;
pub const TARGS: c_int = 262;
pub const TNOPASS: c_int = 263;
pub const TNOLOG: c_int = 264;
pub const TPERSIST: c_int = 265;
pub const TKEEPENV: c_int = 266;
pub const TSETENV: c_int = 267;
pub const TSTRING: c_int = 268;
pub const enum_yytokentype = c_int;
pub const yytoken_kind_t = enum_yytokentype;
pub extern var yylval: yystype; // parse.c:212:1: warning: TODO unable to translate variadic function, demoted to extern
pub extern fn yyerror(fmt: [*c]const u8, ...) void;
pub const YYSYMBOL_YYEMPTY: c_int = -2;
pub const YYSYMBOL_YYEOF: c_int = 0;
pub const YYSYMBOL_YYerror: c_int = 1;
pub const YYSYMBOL_YYUNDEF: c_int = 2;
pub const YYSYMBOL_TPERMIT: c_int = 3;
pub const YYSYMBOL_TDENY: c_int = 4;
pub const YYSYMBOL_TAS: c_int = 5;
pub const YYSYMBOL_TCMD: c_int = 6;
pub const YYSYMBOL_TARGS: c_int = 7;
pub const YYSYMBOL_TNOPASS: c_int = 8;
pub const YYSYMBOL_TNOLOG: c_int = 9;
pub const YYSYMBOL_TPERSIST: c_int = 10;
pub const YYSYMBOL_TKEEPENV: c_int = 11;
pub const YYSYMBOL_TSETENV: c_int = 12;
pub const YYSYMBOL_TSTRING: c_int = 13;
pub const YYSYMBOL_14_n_: c_int = 14;
pub const YYSYMBOL_15_: c_int = 15;
pub const YYSYMBOL_16_: c_int = 16;
pub const YYSYMBOL_YYACCEPT: c_int = 17;
pub const YYSYMBOL_grammar: c_int = 18;
pub const YYSYMBOL_rule: c_int = 19;
pub const YYSYMBOL_action: c_int = 20;
pub const YYSYMBOL_options: c_int = 21;
pub const YYSYMBOL_option: c_int = 22;
pub const YYSYMBOL_strlist: c_int = 23;
pub const YYSYMBOL_ident: c_int = 24;
pub const YYSYMBOL_target: c_int = 25;
pub const YYSYMBOL_cmd: c_int = 26;
pub const YYSYMBOL_args: c_int = 27;
pub const enum_yysymbol_kind_t = c_int;
pub const yysymbol_kind_t = enum_yysymbol_kind_t;
pub const yytype_int8 = i8;
pub const yytype_int16 = c_short;
pub const yytype_uint8 = u8;
pub const yytype_uint16 = c_ushort;
pub const yy_state_t = yytype_int8;
pub const yy_state_fast_t = c_int;
pub const union_yyalloc = extern union {
    yyss_alloc: yy_state_t,
    yyvs_alloc: yystype,
};
pub const yytranslate: [269]yytype_int8 = [269]yytype_int8{
    0,
    2,
    2,
    2,
...
pub const yypact: [33]yytype_int8 = [33]yytype_int8{
    0,
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 2))))),
    2,
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    1,
    5,
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 1))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    8,
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
...
pub const yydefact: [33]yytype_int8 = [33]yytype_int8{
    0,
    0,
    0,
    5,
...
pub const yypgoto: [11]yytype_int8 = [11]yytype_int8{
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 4))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 5))))),
};
pub const yydefgoto: [11]yytype_int8 = [11]yytype_int8{
    0,
    2,
    8,
    9,
...
pub const yytable: [27]yytype_int8 = [27]yytype_int8{
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 2))))),
    1,
    4,
    @as(yytype_int8, @bitCast(@as(i8, @truncate(-@as(c_int, 2))))),
...
pub const yycheck: [27]yytype_int8 = [27]yytype_int8{
    0,
    1,
    0,
    3,
...
pub const yystos: [33]yytype_int8 = [33]yytype_int8{
    0,
    1,
    18,
    14,
...
pub const yyr1: [25]yytype_int8 = [25]yytype_int8{
    0,
    17,
    18,
    18,
...
pub const yyr2: [25]yytype_int8 = [25]yytype_int8{
    0,
    2,
    0,
    2,
...
pub const YYENOMEM: c_int = -2;
const enum_unnamed_9 = c_int;
pub fn yydestruct(arg_yymsg: [*c]const u8, arg_yykind: yysymbol_kind_t, arg_yyvaluep: [*c]yystype) callconv(.C) void {
    var yymsg = arg_yymsg;
    var yykind = arg_yykind;
    var yyvaluep = arg_yyvaluep;
    _ = @TypeOf(yyvaluep);
    if (!(yymsg != null)) {
        yymsg = "Deleting";
    }
...
pub export var yychar: c_int = @import("std").mem.zeroes(c_int);
pub export var yynerrs: c_int = @import("std").mem.zeroes(c_int);
pub const struct_keyword = extern struct {
    word: [*c]const u8,
    token: c_int,
};
pub var keywords: [10]struct_keyword = [10]struct_keyword{
    struct_keyword{
        .word = "deny",
        .token = @as(c_int, 259),
    },
...
}; // parse.c:999:1: warning: TODO implement translation of stmt class LabelStmtClass
pub extern fn yylex() c_int; // parse.c:1165:3: warning: TODO implement translation of stmt class GotoStmtClass
pub export fn yyparse() c_int {
    @panic("unimplemented");
    ...
    //   switch (yyn)
    //     {
    //   case 6: /* rule: action ident target cmd  */
    // #line 89 "parse.y"
    //                                         {
    // 			struct rule *r;
    // 			r = calloc(1, sizeof(*r));
    ...
    //     break;
    //
    //   case 10: /* options: options option  */
    // #line 126 "parse.y"
    //                                    {
    ...
    //     break;
    //
    //   case 15: /* option: TSETENV '{' strlist '}'  */
    // #line 153 "parse.y"
    //                                             {
    // 			yyval.options = 0;
    ...
    //     break;
    //
    //   case 17: /* strlist: strlist TSTRING  */
    // #line 161 "parse.y"
    //                                     {
...
pub const YY_ATTRIBUTE_PURE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // parse.c:392:11
pub const YY_ATTRIBUTE_UNUSED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // parse.c:400:11
pub const YYSTACK_RELOCATE = @compileError("unable to translate macro: undefined identifier `yynewbytes`"); // parse.c:547:10
pub const YYCOPY = @compileError("unable to translate C expr: unexpected token '*'"); // parse.c:565:12
pub const yyerrok = @compileError("unable to translate macro: undefined identifier `yyerrstatus`"); // parse.c:765:9
pub const yyclearin = @compileError("unable to translate C expr: expected ')' instead got '='"); // parse.c:766:9
pub const YYACCEPT = @compileError("unable to translate macro: undefined identifier `yyacceptlab`"); // parse.c:768:9
pub const YYABORT = @compileError("unable to translate macro: undefined identifier `yyabortlab`"); // parse.c:769:9
pub const YYERROR = @compileError("unable to translate macro: undefined identifier `yyerrorlab`"); // parse.c:770:9
pub const YYNOMEM = @compileError("unable to translate macro: undefined identifier `yyexhaustedlab`"); // parse.c:771:9
pub const YYRECOVERING = @compileError("unable to translate macro: undefined identifier `yyerrstatus`"); // parse.c:774:9
pub const YYBACKUP = @compileError("unable to translate macro: undefined identifier `yylen`"); // parse.c:776:9
pub const YY_SYMBOL_PRINT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // parse.c:919:10
pub const YY_STACK_PRINT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // parse.c:920:10
pub const YY_REDUCE_PRINT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // parse.c:921:10
pub const YYPOPSTACK = @compileError("unable to translate macro: undefined identifier `yyvsp`"); // parse.c:1155:9
...
pub const YYBISON = @as(c_int, 30802);
pub const YYBISON_VERSION = "3.8.2";
pub const YYSKELETON_NAME = "yacc.c";
pub const YYPURE = @as(c_int, 0);
pub const YYPUSH = @as(c_int, 0);
pub const YYPULL = @as(c_int, 1);
pub const CONFIG_H = "";
...
pub const YYSTYPE = yystype;
pub const YY_CAST = @import("std").zig.c_translation.Macros.CAST_OR_CALL;
pub const YY_REINTERPRET_CAST = @import("std").zig.c_translation.Macros.CAST_OR_CALL;
pub const YY_NULLPTR = @import("std").zig.c_translation.cast(?*anyopaque, @as(c_int, 0));
pub const YYDEBUG = @as(c_int, 0);
pub const YYTOKENTYPE = "";
pub const YYPTRDIFF_T = __PTRDIFF_TYPE__;
pub const YYPTRDIFF_MAXIMUM = __PTRDIFF_MAX__;
pub const YYSIZE_T = __SIZE_TYPE__;
pub const YYSIZE_MAXIMUM = YY_CAST(YYPTRDIFF_T, if (YYPTRDIFF_MAXIMUM < YY_CAST(YYSIZE_T, -@as(c_int, 1))) YYPTRDIFF_MAXIMUM else YY_CAST(YYSIZE_T, -@as(c_int, 1)));
pub inline fn YYSIZEOF(X: anytype) @TypeOf(YY_CAST(YYPTRDIFF_T, @import("std").zig.c_translation.sizeof(X))) {
    _ = @TypeOf(X);
    return YY_CAST(YYPTRDIFF_T, @import("std").zig.c_translation.sizeof(X));
}
pub inline fn YY_(Msgid: anytype) @TypeOf(Msgid) {
    return Msgid;
}
pub const YY_USE = @import("std").zig.c_translation.Macros.DISCARD;
pub inline fn YY_INITIAL_VALUE(Value: anytype) @TypeOf(Value) {
    return Value;
}
pub const YY_IGNORE_MAYBE_UNINITIALIZED_BEGIN = "";
pub const YY_IGNORE_MAYBE_UNINITIALIZED_END = "";
pub const YY_IGNORE_USELESS_CAST_BEGIN = "";
pub const YY_IGNORE_USELESS_CAST_END = "";
pub inline fn YY_ASSERT(E: anytype) anyopaque {
    return @import("std").zig.c_translation.cast(anyopaque, (@as(c_int, 0) != 0) and (E != 0));
}
pub const YYSTACK_ALLOC = YYMALLOC;
pub const YYSTACK_FREE = YYFREE;
pub const YYSTACK_ALLOC_MAXIMUM = YYSIZE_MAXIMUM;
pub const YYMALLOC = malloc;
pub const YYFREE = free;
pub const YYSTACK_GAP_MAXIMUM = YYSIZEOF(union_yyalloc) - @as(c_int, 1);
pub inline fn YYSTACK_BYTES(N: anytype) @TypeOf((N * (YYSIZEOF(yy_state_t) + YYSIZEOF(YYSTYPE))) + YYSTACK_GAP_MAXIMUM) {
    return (N * (YYSIZEOF(yy_state_t) + YYSIZEOF(YYSTYPE))) + YYSTACK_GAP_MAXIMUM;
}
pub const YYCOPY_NEEDED = @as(c_int, 1);
pub const YYFINAL = @as(c_int, 4);
pub const YYLAST = @as(c_int, 26);
pub const YYNTOKENS = @as(c_int, 17);
pub const YYNNTS = @as(c_int, 11);
pub const YYNRULES = @as(c_int, 24);
pub const YYNSTATES = @as(c_int, 33);
pub const YYMAXUTOK = @as(c_int, 268);
pub inline fn YYTRANSLATE(YYX: anytype) @TypeOf(if ((@as(c_int, 0) <= YYX) and (YYX <= YYMAXUTOK)) YY_CAST(yysymbol_kind_t, yytranslate[@as(usize, @intCast(YYX))]) else YYSYMBOL_YYUNDEF) {
    return if ((@as(c_int, 0) <= YYX) and (YYX <= YYMAXUTOK)) YY_CAST(yysymbol_kind_t, yytranslate[@as(usize, @intCast(YYX))]) else YYSYMBOL_YYUNDEF;
}
pub inline fn YY_ACCESSING_SYMBOL(State: anytype) @TypeOf(YY_CAST(yysymbol_kind_t, yystos[@as(usize, @intCast(State))])) {
    return YY_CAST(yysymbol_kind_t, yystos[@as(usize, @intCast(State))]);
}
pub const YYPACT_NINF = -@as(c_int, 5);
pub inline fn yypact_value_is_default(Yyn: anytype) @TypeOf(Yyn == YYPACT_NINF) {
    return Yyn == YYPACT_NINF;
}
pub const YYTABLE_NINF = -@as(c_int, 3);
pub inline fn yytable_value_is_error(Yyn: anytype) @TypeOf(@as(c_int, 0)) {
    _ = @TypeOf(Yyn);
    return @as(c_int, 0);
}
pub const YYERRCODE = YYUNDEF;
pub inline fn YYDPRINTF(Args: anytype) anyopaque {
    _ = @TypeOf(Args);
    return @import("std").zig.c_translation.cast(anyopaque, @as(c_int, 0));
}
pub const YYINITDEPTH = @as(c_int, 200);
pub const YYMAXDEPTH = @as(c_int, 10000);
...
pub const yyalloc = union_yyalloc;
pub const keyword = struct_keyword;
